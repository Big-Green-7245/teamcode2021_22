 ...
 * is explained below.
 */
@Autonomous(name = "ObjectDetection", group = "Concept")
                    ...
                    if (updatedRecognitions != null) {
                      ...
                      for (Recognition recognition : updatedRecognitions) {
                        ...
                        if(updatedRecognitions.size() != 0){
                            if(recognition.getLabel().equals("blue1")){
                                position = 1;
                            }else if(recognition.getLabel().equals("blue2")){
                                position = 2;
                            }else if(recognition.getLabel().equals("blue3")){
                                position = 3;
                            }
                        }
                      }
