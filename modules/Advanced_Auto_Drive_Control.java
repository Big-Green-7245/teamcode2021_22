...
public class Advanced_Auto_Drive_Control
{
    ...
    public static double GetLength(double[] startPoint, double[] endPoint) {
    ...
    {
        double distance = GetLength(position, location);
        SetBearing(Math.asin(position[0]/distance));
    ...
    public void SetBearing(double bearingDelta)
    {
    ...
    public void advanced_translate(double power, double dX, double dY, double dTheta, double timeout)
    {
        int newFLTarget;
        int newFRTarget;
        int newBLTarget;
